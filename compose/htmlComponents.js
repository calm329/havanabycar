...
<div>
<p>
<img style="max-width: 200px; display: block; margin: auto; margin-bottom: 20px" src="https://https://havanabycar.co/static/media/havana_by_car.png">
</p>
${trafficLines}
</div>`;
...
const mainPaymentLink = (language, booking) => {
    const baseUrl = language == "ENG" ? "https://havanabycar.co/ENG/pay/" : "https://havanabycar.co/pago/";
...
${translation.mailText[language].payNow} ${translation.mailText[language].methods[booking.paymentMethod]}
<br>
<b style="font-size: 25px;">${superTotal} ${booking.currencySymbol}</b>
</a>
</p>
${booking.paymentMethod == "bankPay" ? "<p><b style='color:red'>" + translation.mailText[language].important + ":</b> " + translation.mailText[language].cubaWarning + " <b style='color: red'>'" + booking.causale + "'</b></p>" : ""}
`
    return html;
}

const reactivateBTN = (url, language) => {
    const btnText = language == "ENG" ? "REACTIVATE BOOKING" : "REACTIVAR RESERVA";
    const html = `
<p style="text-align: center; margin: 20px auto;">
...
module.exports = { finishHTML, mainPaymentLink, startHTML, paymentBTN, reactivateBTN, go2PortalBTN };