...
const getExpiryHTML = (translation, language, booking) => {
  const url =
    language == "ENG"
      ? "https://https://cubagoldcar.com/ENG/reactivate/" + booking._id
      : "https://https://cubagoldcar.com/reactivate/" + booking._id;
...
<p>${
    translation.mailText[language].noMoreTime + " " + booking.bookedCar.carModel
  }</p>
...
const getExpiryText = (translation, language, booking) => {
  const url =
    language == "ENG"
      ? "https://https://cubagoldcar.com/ENG/reactivate/" + booking._id
      : "https://https://cubagoldcar.com/reactivar/" + booking._id;
