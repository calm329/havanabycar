...
const getCarCancelledEmailText = (translation, settings, reason) => {
    ...
    const baseUrl = "https://https://havanabycar.co";
    const url = language == "ENG" ? baseUrl + "/ENG/booking/" + settings.booking_id : baseUrl + "/booking/" + settings.booking_id;
    let mailText = translation.mailText[language].intro + ',';
    mailText += '\n\n';
    mailText += translation.mailText[language].sorry + " " + translation.mailText[language][reason];
    mailText += '\n\n';
...
<p>${translation.mailText[language].sorry} ${translation.mailText[language][reason]}</p>
