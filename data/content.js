...
const text = {
  ES: {
    down: {
      ...
      sorry:
        "Pedimos disculpas por las molestias. Estamos trabajando para mejorar el servicio.",
      soon: "Pronto volveremos a estar en línea",
      contact:
        "Para solicitudes de información y/o reservas contactar al correo " +
        config.email,
    },
    //Home
    home: {
      title: "Conducir un carro rentado en Cuba con CUBAGOLDCAR",
      description:
        "Descubre los tesoros de Cuba en un viaje en carro con Cuba Rentar Carro. Explora La Habana, Varadero, Trinidad, Baracoa, Santiago de Cuba, Holguín, Guardalavaca y Las Tunas.",
      keywords:
        "Cuba rentar carro, alquiler de carros en Cuba, road trip Cuba, turismo Cuba",
      start: "RECOGIDA",
      end: "ENTREGA",
      ...
      forYou: "para ti",
      forHim: "para el",
      vip_assistance: "Asistencia VIP",
      vip_assistance_description:
        "Apoyo durante la recogida del automóvil en todas las oficinas de Cuba",
      fuel_included: "Combustible incluido",
      fuel_included_description:
        "Primer tanque completo incluido y garantizado",
      pic: "Fotografa el Carro",
      nextTime:
        "Ahorras <b>100<span class='currencySymbol'></span></b> la proxima vez",
      upload: "Sube la foto",
      btc: "Paga en Bitcoin",
      ...
      catalogo: {
        ...
        explainer:
          "Nuestra extensa red de agencias de alquiler de carros en Cuba pone a disposicion de nuestros cliente carros de gama alta, baja y intermedia. Tenemos cochos para todos los bolsillos.",
        economy: "ECONOMICO",
        medium: "MEDIO",
        luxory: "LUJO",
        from: "Desde",
    ...
    faq: {
      ...
      description:
        "¿Alguna pregunta relacionada con el alquiler Cuba carros? Esta página de preguntas frecuentes resolverá todos sus problemas relacionados con los precios, etc.",
      title: "F.A.Q.",
    ...
    car: {
      ...
      title: "Carro de Renta en Cuba - CUBAGOLDCAR",
      day: "Dia",
      car: "CARRO",
      fleet: "FLOTA",
      results: "RESULTADOS",
    ...
    about: {
      ...
      best: "<b>CUBAGOLDCAR</b> es un agencia de viajes especializada en la Renta deA uto en Cuba. Brindamos servicios de Renta de Autos en Cuba en todas las ciudades de la isla. Nuestro equipo lleva años trabajando y ayudando a los cubanos que viven en el exterior que necesitan Rentar un Auto en Cuba para visitar la familia y a los turistas que quieren conocer Cuba. Por lo que conocemos muy bien cómo ayudarte durante los preparativos para tu viaje a Cuba y sobre todo cómo garantizar que el servicio que has contratado realmente el servicio que vas a recibir cuando hayas llegado a Cuba, sin sorpresas ni preocupaciones.",
      action:
        "Somos un Agencia totalmente Online y somos líder en las Renta de Carros en Cuba. Procesamos más de 10.000 reservas al año y garantizamos el mejor precio del mercado",
      ...
      our_strength: "Nuestros puntos fuertes son:",
      our_strength_1:
        "Asesoramiento y atención personalizada durante la fase de reserva",
      our_strength_2:
        "Oficina en La Habana con Asistencia 24h para cualquier necesidad",
      our_strength_3:
        "Contratos directos y relaciones consolidadas con los proveedores",
      our_strength_4: "Sistema de reserva simple, rápido y siempre actualizado",
      our_strength_5: "Tasa de confirmación de las solicitudes del 90%",
      our_strength_6:
        "Los mejores precios! si encuentras un precio mejor llámanos y nos ponemos de acuerdo",
      car_rental_experience:
        "En <b>CUBAGOLDCAR</b> trabajamos para que tu experiencia de Renta de Auto en Cuba sea la mejor, cuidamos todos los detalles para que esté satisfecho, ya sea que vuelva a reservar con nosotros o nos recomiende a un amigo.",
      contact_question:
        "si desea solicitar una cotización o para cualquier consulta o duda por favor comuníquese con nosotros a través de nuestros contactos",
    },
    //Success
    refundSuccess: {
      ...
      description:
        "<b>Revise el Correo para mas detalles sobre los proximos pasos</b><br> Para revisar el estado de su reserva haga click</b>",
    ...
    success: {
      ...
      success: "EXITO",
      description:
        "<b>¡Hemos recibido tu reserva!</b><br> Recibirás un correo para proceder con el pago.",
    },
    paySuccess: {
      ...
      success: "EXITO",
      description:
        "<b>¡Un vez registrado el pago, va a poder descargar el voucher!</b><br>",
    ...
    summary: {
      ...
      vipAssistant: "<b>Asistencia VIP</b><br>",
    ...
    refund: {
      ...
      explainer:
        "Por favor, utilize el formulario a continuación para proporcionarnos los detalles de la cuenta bancaria donde Usted desea recibir el reembolso.",
      bank: "Banco",
    ...
    how: {
      ...
      pick: "Elejir Carro",
      pickExplainer:
        "Elija un carro en el sitio. Disponibilidad y precios visibles en tiempo real",
      pay: "Pagar Carro",
      payExplainer:
        "Puede pagar por tarjeta de credito, transferencia bancaria, Zelle y Bitcoin.",
      voucher: "Descargar Voucher",
      voucherExplainer:
        "Visite el portal del Cliente y descargue el voucher de la reserva",
    },
    ...
    pay: {
      ...
      cubaWarning:
        "<b>ATENCION:</b> en el concepto no mencione la palabra <b>'CUBA'</b>. Solo ponga ",
      next: function (url) {
        return (
          "<b>Luego, cargue evidencia del pago por medio del <a href='" +
          url +
          "' class='red-link'>PORTAL DEL USUARIO</a></b>"
        );
      },
      ...
      titleCard:
        "Puedes pagar por medio de todas las tarjetas Visa, Mastercard, Maestro y American Express. Para hacerlo proporcione los datos de su tarjeta.",
    ...
    map: {
      title: "Mapa del Sitio - CUBAGOLDCAR",
      description:
        "Este mapa del sitio de rent a car Cuba le ayudará a navegar por nuestro sitio de manera efectiva. ¡Consulta la breve estructura de havanabycar desde aquí!",
    ...
    blog: {
      ...
      description:
        "En esta sección del blog, encontrará las últimas actualizaciones, consejos y asistencia con respecto al servicio carro Cuba alquiler. ¡Échale un vistazo ahora!",
      descriptionSEO:
        "Algunos consejos prácticos para alquilar un carro en Cuba",
      readMore: "Leer Más",
    },
    welcomeBlog: {
      mainTitle: "Mejor Empresa De Alquiler De Carros En Cuba - havanabycar",
      description:
        "¿Busca información sobre alquiler de autos en Cuba? ¡Lee nuestros últimos artículos relacionados con los servicios de alquiler de carros y sus características!",
  ...
  ENG: {
    down: {
      ...
      sorry:
        "We apologize for any inconvenience. We are working to improve the service.",
      soon: "We will be back online soon.",
      contact:
        "For information requests and reservations, contact by email " +
        config.email,
    },
    //Home
    home: {
      ...
      description:
        "Rent a car in Cuba and explore the island's top destinations, including Havana, Viñales, Trinidad, and Varadero. Discover the best of Cuba with Cuba Car Rental.",
      start: "PICKUP",
      end: "DROPOFF",
      ...
      place: "Place",
      promo: "PROMO",
      gold_service: "Gold Service",
      offers: "BARGAINS",
      perDay: "FROM",
      insuranceIncluded: "INSURANCE INCLUDED",
      manualCheap: "Manual<br>Economy",
      automaticoCheap: "Automatic<br>Economy",
      vip_assistance: "VIP Assistance",
      vip_assistance_description:
        "Support during Car Pick-Up at all offices in Cuba",
      forYou: "for you",
      forHim: "for him",
      pic: "Take a Picture",
      ...
      fuel_included_description: "First full tank included and guaranteed",
      save10: "Save <b>10%</b>",
      ...
      catalogo: {
        ...
        explainer:
          "Our extended network of Car Rental Agencies in Cuba puts at out customers' disposal a wide range of cars to suit any pocket.",
        economy: "ECONOMY",
        medium: "MEDIUM",
        luxory: "LUXORY",
        from: "From",
    ...
    car: {
      ...
      title: "Car Rental in Cuba - CUBAGOLDCAR",
      day: "Day",
      car: "CAR",
      results: "RESULTS",
      included: "INCLUDED",
    ...
    //About
    about: {
      mainTitle: "About Us || CUBAGOLDCAR",
      title: "About Us",
      best: "<b>CUBAGOLDCAR</b> is a travel agency specialized in car rentals in Cuba. We provide Car Rental services in Cuba in all cities on the island. Our team has been working for years and helping Cubans living abroad who need to Rent a Car in Cuba to visit family and tourists who want to get to know Cuba. So we know very well how to help you during the preparations for your trip to Cuba and above all how to guarantee that the service you have contracted is really the service you are going to receive when you have arrived in Cuba, without surprises or worries.",
      action:
        "We are a 100% online agency and we are the leader in the market of Car Rental in Cuba. We process over 10.000 bookings per year and we offer the best prices on the market.",
      ...
      our_strength: "Our strengths are:",
      our_strength_1:
        "Advice and personalized attention during the reservation phase",
      our_strength_2: "Office in Havana with 24-hour assistance for any need",
      our_strength_3:
        "Direct contracts and consolidated relationships with suppliers",
      our_strength_4: "Simple, fast and always updated reservation system",
      our_strength_5: "90% application confirmation rate",
      our_strength_6:
        "The best prices! If you find a better price, call us and we will agree",
      car_rental_experience:
        "At <b>CUBAGOLDCAR</b> we work to make your Car Rental experience in Cuba the best, we take care of all the details so that you are satisfied, whether you book with us again or recommend us to a friend.",
      contact_question:
        "If you would like to request a quote or for any questions or concerns, please contact us through our contacts.",
    },
    faq: {
    ...
    success: {
      ...
      success: "SUCCESS",
      description:
        "<b>We have received your booking!</b><br> You will get an email with payment instructions.",
    },
    refundSuccess: {
      mainTitle: "Data Sent",
      title: "Bank Data Sent",
      description:
        "<b>Check your email for more information on next steps.</b><br> To check the status of your refund, please click</b>",
    ...
    paySuccess: {
      ...
      success: "SUCCESS",
      description:
        "<b>As soon as your payment is registered you will be able to download the Voucher.</b><br>",
    ...
    summary: {
      ...
      vipAssistant: "<b>VIP Assistant</b><br>",
    ...
    refund: {
      ...
      explainer:
        "Please use the form below to provide us with the details of the bank account where you would like to receive your refund.",
      bank: "Bank",
    ...
    how: {
      ...
      pickExplainer:
        "Find the car you want on our website. Availability and prices are shown in real time.",
      pay: "Pay for the Car",
      payExplainer:
        "You can pay by Credit Card, Bank Transfer, Zelle and Bitcoin.",
      voucher: "Download Voucher",
      voucherExplainer:
        "Check the details of your reservation in the Customer Portal and download the Booking Voucher",
    },
    ...
    pay: {
      ...
      pleaseCausale:
        "In the reason for the transaction field, please make sure you insert",
      toBank: "to the following bank account:",
      payB4: "Pay before:",
      cubaWarning:
        "<b>ATTENTION</b>: in the reason for transfer field, never mention the word <b>'CUBA'</b>. Just put ",
      next: function (url) {
        return (
          "<b>Finally, please upload evidence of the transaction through the <a href='" +
          url +
          "' class='red-link'>USER PORTAL</a></b>"
        );
      },
      ...
      titleCard:
        "You can pay with any Visa, Mastercard, Maestro y American Express. To do that, please provide your card data.",
